# %% [markdown]
# # The link prediction task with `SEAL`
# `SEAL` framework learns general graph structure features for link prediction. which contains three steps:
#
# * Enclosing subgraph extraction.
# * Node information matrix construction.
# * `GNN` learning.
# 
# More details see the paper `Link Prediction Based on Graph Neural Networks`.
#
# References: [pytorch_geometric examples](https://github.com/pyg-team/pytorch_geometric/blob/master/examples/seal_link_pred.py)

# %% [markdown]
# Prepare SEAL Dataset
